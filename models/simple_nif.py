...
class simple_NIF(PytorchNIF):
    def __init__(self, cfg, criterion='mse', logger=None, opt='adam', device='cpu', ckpt_save_path=None, tag=''):
        ...
        self.cfg_shape_net['layers'] =[self.cfg_shape_net['units']]*(self.cfg_shape_net['nlayers'])
